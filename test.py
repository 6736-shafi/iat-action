...
# path=os.path.exists(os.path.join(script_dir, 'config'))
# print(f"Config directory exists: {os.path.join(script_dir, 'config')}")
from config.connect import get_ml_client
from component.register_model.test import add
add()
...
#         print(f"Found project root at: {current_dir}")
